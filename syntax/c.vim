...
syn match MacroNames "\v[A-Z0-9_]{2,};"
syn match Print "printf"
syn match Scan "scanf"
syn match Put "puts"
syn match Main "main"
syn match Name "[A-Z]"
" Options: #cc00aa, #c900ff, #7000ff, #6000ff, #ff00ff
highlight Braces guifg=#464b5d guibg=NONE gui=BOLD
highlight Ops guifg=#c900ff guibg=NONE gui=NONE
highlight Data guifg=#7000ff guibg=NONE gui=bold
highlight MacroNames guifg=#00ff00 guibg=NONE
highlight print guifg=#6000ff guibg=none gui=NONE
highlight scan guifg=#6000ff guibg=none gui=NONE
highlight Put guifg=#6000ff guibg=NONE gui=NONE
highlight Main guifg=#ff00ff guibg=NONE 
highlight Name guifg=#7000ff guibg=NONE gui=bold
